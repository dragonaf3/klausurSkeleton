...
public class LautstaerkeModel {
     ...
     */
    private ObservableList<String> stile = FXCollections.observableArrayList("Chamber", "Country", "Cowbell", "Metal", "Polka", "Rock");
    ...
    public void setBalance(double balance) {
        if (balance >= 0 && balance <= 1) this.balance.set(balance);
    }
